...
var parseBoxData = function(str) {
  ...
  const boxData = {
    color,
    text: title !== void 0 ? sanitizeText$1(title.replace(/^:?(?:no)?wrap:/, ""), getConfig()) : void 0,
...
var addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = sanitizeText$1(text.text, getConfig());
...
//# sourceMappingURL=sequenceDiagram-446df3e4-QQRNPCKP.js.map
