<template><div><h3 id="何为io" tabindex="-1"><a class="header-anchor" href="#何为io" aria-hidden="true">#</a> 何为IO？</h3>
...
<p>在客户端连接数量不高的情况下是没有问题的，但是当并发数量增大的时候，传统的BIO模型是无能为力的，会导致多线程阻塞，响应不了其他请求。</p>
