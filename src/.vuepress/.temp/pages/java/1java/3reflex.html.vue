...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DebugInvocationHandler</span> <span class="token keyword">implements</span> <span class="token class-name">InvocationHandler</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中的<code v-pre>Method</code>就是反射类。</p>
<p>SpringBoot中使用<code v-pre>@Component</code>就能声明一个Bean，原理就是基于反射获取到对应类上的注解，再做处理。</p>
<h3 id="反射的优缺点" tabindex="-1"><a class="header-anchor" href="#反射的优缺点" aria-hidden="true">#</a> 反射的优缺点</h3>
<p>优点：让代码更加灵活，为各种框架提供开箱即用的便利。</p>
<p>缺点：拥有分析操作类的能力，增加了安全隐患。</p>
<h3 id="反射获取class对象" tabindex="-1"><a class="header-anchor" href="#反射获取class对象" aria-hidden="true">#</a> 反射获取Class对象</h3>
<ol>
<li>知道具体类的情况下：</li>
</ol>
...
<li>通过<code v-pre>Class.forName()</code>传入类的全路径名：</li>
</ol>
...
<li>通过实例对象的<code v-pre>getClass()</code>获取：</li>
</ol>
...
<li>通过类加载器<code v-pre>xxxClassLoader.loadClasss()</code>传入类路径获取：</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>通过类加载器获取Class对象不会进行初始化，意味着静态代码块和静态对象不会得到执行。</p>
<h3 id="获取方法并执行" tabindex="-1"><a class="header-anchor" href="#获取方法并执行" aria-hidden="true">#</a> 获取方法并执行</h3>
