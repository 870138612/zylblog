...
<h3 id="面向对象和面向过程的区别" tabindex="-1"><a class="header-anchor" href="#面向对象和面向过程的区别" aria-hidden="true">#</a> 面向对象和面向过程的区别</h3>
<ul>
...
<p>一个注重过程，一个注重内部属性。</p>
<!-- more -->
<h3 id="对象的相等和引用的相等" tabindex="-1"><a class="header-anchor" href="#对象的相等和引用的相等" aria-hidden="true">#</a> 对象的相等和引用的相等</h3>
<p>对象的相等是是比较内存中存放的对象是否相等。</p>
<p>引用相等是指向的内存地址是否相等。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> str1 <span class="token operator">=</span> <span class="token string">"a"</span><span class="token punctuation">;</span>
...
<p>构造方法不能被重写<code v-pre>@Override</code>，但是能重载（有参构造和无参构造）。</p>
<h3 id="面向对象的三个特征" tabindex="-1"><a class="header-anchor" href="#面向对象的三个特征" aria-hidden="true">#</a> 面向对象的三个特征</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@tab Hero1</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Hero1</span> <span class="token keyword">extends</span> <span class="token class-name">Hero</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@tab Hero2</p>
...
<ol>
<li>子类拥有父类的所有属性和方法（包括私有属性和私有方法）。</li>
<li>子类能对父类进行扩展。</li>
</ol>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@tab Hero1</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Hero1</span> <span class="token keyword">extends</span> <span class="token class-name">Hero</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@tab Hero2</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Hero2</span> <span class="token keyword">extends</span> <span class="token class-name">Hero</span><span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">skill</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"技能2"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<li>对象类型和引用类型之间具有继承/实现关系；</li>
<li>引用类型变量发出的方法调用到底是哪个类中的方法，在程序运行的时候才能确定；</li>
<li>多态不能调用只在子类中存在，但是父类中不存在的方法，也就是<code v-pre>hero</code>能调用的方法是看父类<code v-pre>Hero</code>的，执行的结果看子类<code v-pre>Hero1</code>；</li>
<li>如果子类重写了父类方法，则执行的是子类中的方法，如果没有重写则执行的是父类中的方法。</li>
</ul>
<h3 id="接口和抽象类的共同点" tabindex="-1"><a class="header-anchor" href="#接口和抽象类的共同点" aria-hidden="true">#</a> 接口和抽象类的共同点</h3>
<p><strong>共同点</strong></p>
<ul>
<li>都不能被实例化；</li>
<li>都可以包含抽象方法；</li>
<li>都可以有默认的实现方法（Java8可以用<code v-pre>default</code>关键字在接口中定义默认方法）。</li>
</ul>
<p><strong>不同点</strong></p>
<ul>
<li>接口强调行为的约束，实现某个接口就相当于有某个责任，必须实现对应的方法，继承则是强调复用，子类继承父类并不一定要重写父类方法；</li>
<li>一个类只能<code v-pre>extends</code>一个类，但是能<code v-pre>implements</code>多个接口；</li>
<li>接口中的成员变量只能是<code v-pre>public static final</code>类型，不能被修改而且必须有初始值，抽象类中的成员变量默认default，可以在子类中被重新定义，重新赋值。</li>
</ul>
<h3 id="浅拷贝-深拷贝-引用拷贝" tabindex="-1"><a class="header-anchor" href="#浅拷贝-深拷贝-引用拷贝" aria-hidden="true">#</a> 浅拷贝，深拷贝，引用拷贝</h3>
<p><strong>浅拷贝</strong></p>
<p>在堆上创建一个新对象N，N对象中的内部对象是引用类型的话，会直接复制原本类O的内部对象引用地址；</p>
<p>也就是新对象N内部对象和原来的对象O的内部对象是同一个。</p>
<p><strong>深拷贝</strong></p>
<p>不仅仅拷贝对象，将原本对象内部的所有属性都单独复制一份；</p>
<p>新对象的内部引用对象不再是原来对象的内部引用对象。</p>
<p><strong>引用拷贝</strong></p>
<p>两个不同对象的引用指向同一个对象。</p>
<h2 id="object" tabindex="-1"><a class="header-anchor" href="#object" aria-hidden="true">#</a> Object</h2>
<h3 id="和equals区别" tabindex="-1"><a class="header-anchor" href="#和equals区别" aria-hidden="true">#</a> ==和equals区别</h3>
<ul>
<li>对于基本类型来说==是比较值；</li>
<li>对于引用类型来说==是比较地址。</li>
</ul>
<p><code v-pre>equals</code>存在两种情况：</p>
<ul>
<li>类没有重写<code v-pre>equals</code>方法：则通过<code v-pre>equals</code>比较两个对象的时候等价于<code v-pre>==</code>；</li>
<li>重写了<code v-pre>equals</code>方法：则是比较两个对象内部的属性是否相等。</li>
</ul>
<p>创建<code v-pre>String</code>类型的对象，虚拟机会在字符串常量池中查找有没有相同值的对象，如果有则直接返回这个对象的引用，如果没有就创建一个<code v-pre>String</code>对象。</p>
<h3 id="hashcode-作用" tabindex="-1"><a class="header-anchor" href="#hashcode-作用" aria-hidden="true">#</a> hashCode()作用</h3>
<p><code v-pre>hashCode()</code>方法用来获哈希码，作用是确定在哈希表中的位置。</p>
<p><code v-pre>hashCode()</code>定义在<code v-pre>Object</code>类中，所以所有的对象都有这个方法。<code v-pre>hashCode()</code>是本地方法，也就是通过C或者是C++实现的。</p>
<p><code v-pre>HashMap</code>通过计算<code v-pre>Hash</code>值使得查找元素的时间复杂度为1，数据结构散列表。</p>
<h3 id="为什么重写-equals-时必须重写-hashcode-方法" tabindex="-1"><a class="header-anchor" href="#为什么重写-equals-时必须重写-hashcode-方法" aria-hidden="true">#</a> 为什么重写 equals() 时必须重写 hashCode() 方法？</h3>
<ul>
<li>
<p>Java中如果两个对象相同则<code v-pre>HashCode</code>，必须相等；</p>
</li>
<li>
<p>如果<code v-pre>HashCode</code>相同，则对象不一定相等；</p>
</li>
<li>
<p>如果两个对象的<code v-pre>HashCode</code>不同则对象一定不同。</p>
</li>
</ul>
<p>重写<code v-pre>equals()</code>代表这个方法是用来比较两个对象是否相等，如果不重写<code v-pre>HashCode()</code>方法可能会导致判断是相等的两个对象但是<code v-pre>HashCode</code>不等。</p>
...
<ul>
<li><code v-pre>String</code>是不可变的，可以看成常量，线程安全。对内部方法加了同步锁，是线程安全的。<code v-pre>StringBuilder</code>没有添加同步锁，所以是线程不安全的。</li>
<li>每次对<code v-pre>String</code>类型进行修改的时候，都会新生成一个<code v-pre>String</code>类型，然后将引用指向新的<code v-pre>String</code>对象。<code v-pre>StringBuffer</code>和<code v-pre>StringBuilder</code>是对对象本身进行操作，不会生成新的对象，相同情况下使用<code v-pre>StringBuilder</code>会带来一点性能提升，但是线程不安全。</li>
<li>少量数据使用<code v-pre>String</code>，单线程下大量数据使用<code v-pre>StringBuilder</code>，多线程下使用<code v-pre>StringBuffer</code>。</li>
</ul>
<h3 id="string为何不可变" tabindex="-1"><a class="header-anchor" href="#string为何不可变" aria-hidden="true">#</a> String为何不可变？</h3>
<p>JDK8中的源码：</p>
...
<li>
<p>保存字符串的数组是<code v-pre>final</code>修饰的，并且内部没有暴露能修改这个数组的方法；</p>
</li>
<li>
<p><code v-pre>String</code>类本身也被<code v-pre>final</code>修饰导致不能被继承，从而避免子类破坏<code v-pre>String</code>的不变性。</p>
</li>
</ul>
<h3 id="字符串拼接用-还是-stringbuilder" tabindex="-1"><a class="header-anchor" href="#字符串拼接用-还是-stringbuilder" aria-hidden="true">#</a> 字符串拼接用“+” 还是 StringBuilder?</h3>
<p>+和+=是Java中唯二为<code v-pre>String</code>重载过的运算符。</p>
<p><code v-pre>String</code>对象使用+进行拼接，实际就是通过<code v-pre>StringBuilder</code>调用<code v-pre>append()</code>方法，拼完之后调用<code v-pre>toString()</code>方法返回<code v-pre>String</code>对象。</p>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p>如果在循环内使用+进行拼接多个字符串，编译器不会复用<code v-pre>StringBuilder</code>，而是每次循环都创建一个<code v-pre>StringBuilder</code>。</p>
<p>直接使用<code v-pre>StringBuilder</code>进行拼接就能解决这个问题。</p>
</div>
<h3 id="string-s1-new-string-abc-这句话创建了几个字符串对象" tabindex="-1"><a class="header-anchor" href="#string-s1-new-string-abc-这句话创建了几个字符串对象" aria-hidden="true">#</a> String s1 = new String(&quot;abc&quot;);这句话创建了几个字符串对象？</h3>
<p>会创建1个或者2个字符串对象。、</p>
...
<ul>
<li>如果字符串常量池中保存了对应的字符串对象的引用，则返回引用。</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于<code v-pre>String str3 = &quot;a&quot; + &quot;b&quot;</code>等价于<code v-pre>String str3 = &quot;ab&quot;</code>；对于在编译期间就能确定的字符串，编译器会在编译期间直接放入字符串常量池中。</p>
<p><code v-pre>String str4 = str1 + str2;</code>则不会在编译期间确定结果，不会产生优化。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用<code v-pre>final</code>修饰则看成常量，在编译期间就会优化放入字符串常量池中。</p>
<h2 id="java值传递" tabindex="-1"><a class="header-anchor" href="#java值传递" aria-hidden="true">#</a> Java值传递</h2>
<h3 id="形参和实参" tabindex="-1"><a class="header-anchor" href="#形参和实参" aria-hidden="true">#</a> 形参和实参</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s <span class="token operator">=</span> <span class="token string">"abc"</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="值传递-引用传递" tabindex="-1"><a class="header-anchor" href="#值传递-引用传递" aria-hidden="true">#</a> 值传递&amp;引用传递</h3>
<ul>
<li>值传递：方法接收的是实参的拷贝，会创建副本；</li>
<li>引用传递：方法接收的直接是实参所引用对象在堆中的地址，不会创建副本，对形参的修改将会影响到实参。</li>
</ul>
<h3 id="java只有值传递" tabindex="-1"><a class="header-anchor" href="#java只有值传递" aria-hidden="true">#</a> Java只有值传递</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>array为引用类型，但是不称为引用传递，案例中仍然是值传递，值是实参的地址。</p>
<p>引用传递值得是：对形参本身修改会导致实参变化。</p>
<h2 id="java序列化" tabindex="-1"><a class="header-anchor" href="#java序列化" aria-hidden="true">#</a> Java序列化</h2>
<ul>
<li><strong>序列化</strong>：将数据结构或对象转换成二进制字节流的过程</li>
<li><strong>反序列化</strong>：将在序列化过程中所生成的二进制字节流转换成数据结构或者对象的过程</li>
</ul>
<p>序列化协议属于TCP/IP中的应用层。</p>
<p>Java中通过实现<code v-pre>Serializable</code>接口实现序列化功能。</p>
<h3 id="serialversionuid-有什么作用" tabindex="-1"><a class="header-anchor" href="#serialversionuid-有什么作用" aria-hidden="true">#</a> serialVersionUID 有什么作用？</h3>
<p><code v-pre>serialVersionUID</code>的作用是版本控制，反序列化的时候会检查<code v-pre>serialVersionUID</code>是否和当前类的<code v-pre>serialVersionUID</code>相同，如果不同则会抛出<code v-pre>InvalidClassException</code>异常。如果不指定<code v-pre>serialVersionUID</code>，编译器会自动生成。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>serialVersionUID</code>用来给JVM识别的，并不会被序列化。</p>
</div></template>
