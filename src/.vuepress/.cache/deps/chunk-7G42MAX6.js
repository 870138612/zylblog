import {
  createText
} from "./chunk-ZOMXBULC.js";
import {
  parseMember
} from "./chunk-4UFF4LJD.js";
import {
  decodeEntities
} from "./chunk-2XTEPAGQ.js";
import {
  utils
...
var labelHelper = (parent, node, _classes, isNode) => {
  ...
  if (node.labelType === "markdown") {
    text = createText(label, sanitizeText$1(decodeEntities(labelText), getConfig()), {
      useHtmlLabels,
    ...
    text = textNode.appendChild(
      createLabel$1(
        sanitizeText$1(decodeEntities(labelText), getConfig()),
        node.labelStyle,
        false,
        isNode
      )
...
//# sourceMappingURL=chunk-7G42MAX6.js.map
