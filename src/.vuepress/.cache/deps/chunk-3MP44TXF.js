...
function createDOMPurify() {
  ...
  var _isValidAttribute = function _isValidAttribute2(lcTag, lcName, value) {
    ...
    if (ALLOW_DATA_ATTR && !FORBID_ATTR[lcName] && regExpTest(DATA_ATTR$1, lcName))
      ...
      if (
        // First condition does a very 基础 check if a) it's basically a valid custom element tagname AND
...
var sanitizeText$1 = (text2, config2) => {
  if (!text2) {
    return text2;
  }
...
var sanitizeTextOrArray = (a2, config2) => {
  if (typeof a2 === "string") {
    return sanitizeText$1(a2, config2);
  }
  return a2.flat().map((x3) => sanitizeText$1(x3, config2));
};
...
var diagramTitle = "";
var description = "";
var sanitizeText = (txt) => sanitizeText$1(txt, getConfig());
var clear = function() {
  title = "";
  description = "";
  diagramTitle = "";
...
*/
//# sourceMappingURL=chunk-3MP44TXF.js.map
