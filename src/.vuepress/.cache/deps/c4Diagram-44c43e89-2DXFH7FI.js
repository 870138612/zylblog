...
var setC4Type = function(c4TypeParam) {
  let sanitizedText = sanitizeText$1(c4TypeParam, getConfig());
...
var setTitle = function(txt) {
  let sanitizedText = sanitizeText$1(txt, getConfig());
  title = sanitizedText;
};
var c4Db = {
  addPersonOrSystem,
...
//# sourceMappingURL=c4Diagram-44c43e89-2DXFH7FI.js.map
